                ...
                <div className='border border-[#D0D0D0] rounded-rounded-10 p-12 md:p-20'>
                    ...
                    <form action="">
                        <div className='mb-b-30'>
                            <label className="text-theme-body text-lg leading-leading-21 font-semibold" for="name">
                                Name
                            </label>
                            <input
                    ...
                    <p className='text-lg font-normal text-theme-text text-center leading-leading-21'>
                        Have an account? <Link to='/dashboard/login' className='font-semibold text-theme-default'>Login</Link>
                    </p>
                </div>
            </div>
        </div>
